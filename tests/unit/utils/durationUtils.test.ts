...
describe("formatTenure", () => {
  it("formats years and months like experience copy", () => {
    expect(formatTenure(34)).toBe("2 yr 10 mos")
    ...
    expect(formatTenure(3)).toBe("3 mos")
  })
})

describe("formatRoleDuration", () => {
  it("formats completed roles with tenure", () => {
    expect(formatRoleDuration({ month: "Oct", year: 2023 }, { month: "Jul", year: 2026 })).toBe("Oct 2023 - Jul 2026 (2 yr 10 mos)")
  ...
  it("formats ongoing roles with a live tenure", () => {
    ...
    expect(formatRoleDuration({ month: "Aug", year: 2025 }, undefined, new Date(2026, 7, 1))).toBe("Aug 2025 - Present (1 yr 1 mos)")
  })
