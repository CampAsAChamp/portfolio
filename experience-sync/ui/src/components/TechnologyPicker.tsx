...
/** Render a technology's SVG icon, or a blank fallback when the asset is missing. */
...
/** Move an item in `list` from `from` to `to` (no-op for out-of-range indexes). */
...
/**
 * Multi-select technologies from the portfolio catalog, with drag/keyboard reorder
 * for the display order written into YAML.
 */
